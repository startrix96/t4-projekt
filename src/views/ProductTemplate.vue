...
<section class="secondsection">
    ...
    <div class="reviewbeskrivelse"><h3>Fantastisk spil</h3><div class="flexstars">
        <div class="clip-star"></div>
        <div class="clip-star"></div>
        <div class="clip-star"></div>
        <div class="clip-star"></div>
        ...
        <p>Første spil i lang tid, hvor du får præcis det du betaler for og har set af annoncer. 
        Der er ikke battlepass, det er en stor legeplads hvor det eneste der begrænser din nydelse og progression er en selv. 
        Det er en storslået verden med en fantastisk mission hvor det handler om at udvikle sig selv og ens redskaber. 
        Der er få fejl i spillet, hvilket giver en dejlig glidende til gang til alle spillets funktioner. 
        Jeg ville ønske andre spiludviklere ville ligge så meget kærlighed og dedikation i spillene.</p>
    </div>
</section>
</template>
