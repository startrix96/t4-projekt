<template>
    ...
    <section class="queryfirstsection">
        <img src="../../public/images/elden-ring.webp" />
        <div class="queryflexsection">
            <div class="flex-container">
                <h2 class="queryproduct">{{ products.attributes.title }}</h2>
            </div>
            <div class="flexstars">
                <div class="clip-star"></div>
                <div class="clip-star"></div>
    ...
    <div class="querycenterreview">
        <h2>Anmeldelser</h2>
    </div>
    <section class="querysecondsection">
        <div class="reviewbeskrivelse">
